...
void AAICharacter::BeginPlay()
{
	...
	m_current_linear_velocity = FVector(0.0f, 0.0f,1.0f);
}
...
void AAICharacter::Tick(float DeltaTime)
{
	...
	m_current_linear_velocity = (m_params.targetPosition - GetActorLocation()).GetSafeNormal() * m_params.max_velocity;
	SetActorLocation((GetActorLocation() + m_current_linear_velocity)*DeltaTime);
	DrawDebug();
}
