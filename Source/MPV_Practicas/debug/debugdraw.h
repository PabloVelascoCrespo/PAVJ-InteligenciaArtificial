...
void SetPath(const AActor* owner, const FString& path_actor_name, const FString& path_name, const TArray<FVector2D>& PathPoints, float PathThickness, UMaterialInterface* material);
