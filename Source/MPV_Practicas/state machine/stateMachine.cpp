...
void StateMachine::load(AAICharacter* Owner)
{
  ...
  // 2. Crear acciones
  auto* A_SetIdleImg = new SetImage(Owner, "/Game/PaperAssets/Golem/S_Golem_03_Idle_000_Sprite.S_Golem_03_Idle_000_Sprite");
  auto* A_SetAlertImg = new SetImage(Owner, "/Game/PaperAssets/Golem/S_Golem_03_Idle_000_Sprite.S_Golem_03_Idle_000_Sprite");
  auto* A_SetAttackImg = new SetImage(Owner, "/Game/PaperAssets/Golem/T_Golem_03_Attacking_008_Sprite.T_Golem_03_Attacking_008_Sprite");
  auto* A_SetDeadImg = new SetImage(Owner, "/Game/PaperAssets/Golem/T_Golem_03_Dying_014_Sprite.T_Golem_03_Dying_014_Sprite");
  ...
  auto* S_Alert = new State(A_SetAlertImg, nullptr, A_MoveToPlayer, {});
